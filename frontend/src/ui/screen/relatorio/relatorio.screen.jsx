...
const renderizarRelatorioTarefa = tarefa => {
    const labels = Object.keys(tarefa.porData).map(label => label)

    const datasets = labels.map(label => {
        return { label: label, data: tarefa.porData[label] }
    })
            ...
            <section className="relatorio">
                <div className="relatorio__pomodoro">
                    ...
                    <div className="relatorio__legenda">
                        ...
                        <p className="relatorio__texto">{`Tempo total de foco: ${relatorio.pomodoro.tempoTotalFoco}`}</p>
                    </div>
                </div>
